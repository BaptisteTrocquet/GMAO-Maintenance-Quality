...
describe("analytics benchmark fixture", () => {
  ...
  it("covers open/completed/cancelled, corrective/preventive, labor and incomplete-cost cases", () => {
    const fixture = buildAnalyticsBenchmarkFixture();
    ...
    expect(fixture.workOrders.some((workOrder) => (workOrder.laborMinutes ?? 0) > 0)).toBe(true);

...
describe("GET /api/analytics/mttr", () => {
  it("resolves local calendar dates and optional asset before querying MTTR", async () => {
  ...
  it("preserves a Europe/Paris local day across the DST transition", async () => {
    const response = await GET(
  ...
  it("rejects missing or timestamp-shaped date inputs before authentication", async () => {

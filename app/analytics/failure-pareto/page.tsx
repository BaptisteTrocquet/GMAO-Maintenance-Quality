...
import FailureParetoClient from "./failure-pareto-client";

export default async function FailureParetoPage() {
  ...
  if (!organizationId || !siteId) {
    return (
      <>
        <div className="header"><div><div className="title">Failure Pareto</div></div></div>
    ...
    <>
      <div className="header asset-header">
        <div>
          ...
          <div className="title">Failure Pareto</div>

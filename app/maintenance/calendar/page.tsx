    ...
    <>
      ...
      <section className="card" aria-label="Calendar month navigation">
        ...
        <p className="muted" style={{ marginBottom: 0 }}>
          Drag work orders onto a day to change their planned start. The original local start time is preserved; unscheduled work defaults to 08:00 in the organization timezone. Keyboard and mobile users can use the date fields instead. Every change still goes through the permission-checked work-order API and audit log.
        </p>
        {truncated ? (

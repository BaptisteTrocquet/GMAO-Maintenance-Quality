...
import { InventoryLocationError, updateWarehouse } from "@/lib/inventory/warehouses";
...
const updateSchema = z
  ...
  .refine(
    ...
    "At least one warehouse field must be supplied",
  );
...
export async function PATCH(
  ...
  if (!parsed.success) {
    return apiError(400, "INVALID_PAYLOAD", "Invalid warehouse update", parsed.error.flatten());
  }

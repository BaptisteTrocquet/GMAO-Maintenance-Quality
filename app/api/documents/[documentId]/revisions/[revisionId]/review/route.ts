...
import { DocumentWorkflowError, submitRevisionForReview } from "@/lib/documents/workflow";
...
export async function POST(
  ...
  if (!parsed.success) return apiError(400, "INVALID_PAYLOAD", "Invalid review request", parsed.error.flatten());
